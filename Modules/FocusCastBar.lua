...
FocusCastBarFrame.SpellNameText = FocusCastBarFrame.CastBar:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
...
FocusCastBarFrame.InterruptCooldownFrame.Icon = FocusCastBarFrame.InterruptCooldownFrame:CreateTexture(nil, "ARTWORK")
...
FocusCastBarFrame.InterruptCooldownFrame.Border:SetPoint("BOTTOMRIGHT", FocusCastBarFrame.InterruptCooldownFrame, 1, -1)
